 ...
 */
public class AsynchronousClientWithCompletionHandler {
    ...
    public static void main(String[] args) {
        ...
        try(AsynchronousSocketChannel asynchronousSocketChannel = AsynchronousSocketChannel.open()) {
            if (asynchronousSocketChannel.isOpen()) {
                ...
                asynchronousSocketChannel.connect(new InetSocketAddress(ip, port), null, new CompletionHandler<Void, Void>() {
